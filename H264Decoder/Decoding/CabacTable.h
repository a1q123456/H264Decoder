...
{
    constexpr int CABAC_NAN = std::numeric_limits<int>::min();

    constexpr int mnValues0_10[][2] =
    {
    ...
    constexpr int mnValuesI54_59[][2] =
    {
        { CABAC_NAN, CABAC_NAN }, { CABAC_NAN, CABAC_NAN }, { CABAC_NAN, CABAC_NAN }, { CABAC_NAN, CABAC_NAN },
        { CABAC_NAN, CABAC_NAN }, { CABAC_NAN, CABAC_NAN },
    };

    constexpr int mnValuesISI70_398[][2] =
    {
        { 0, 11 }, { 1, 55 }, { 0, 69 }, { -17, 127 },
        { -13, 102 },{ 0, 82 }, { -7, 74 }, { -21, 107 },
        { -27, 127 },{ -31, 127 },{ -24, 127 }, { -18, 95 },
        { -27, 127 },{ -21, 114 },{ -30, 127 }, { -17, 123 },
        { -12, 115 },{ -16, 122 }, { -11, 115 },{ -12, 63 },
        { -2, 68 }, { -15, 84 },
    ...
    constexpr int mnValuesI399_459[][2] =
    {
        {  31, 21 }, {  31, 31 }, {  25, 50 },
    ...
    constexpr int mnValuesISI460_659[][2] =
    {
    ...
    constexpr int mnValuesI660_775[][2] =
    {
        { -17, 120 }, { -20, 112 }, { -18, 114 }, { -11, 85 },
        { -15, 92 }, { -14, 89 }, { -26, 71 }, { -15, 81 },
        { -14, 80 }, {   0, 68 }, { -14, 70 }, { -24, 56 },
    ...
    constexpr int mnValuesISI776_1023[][2] =
    {
        {  -6, 93 }, {  -6, 84 }, {  -8, 79 }, {   0, 66 },
        {  -1, 71 }, {   0, 62 }, {  -2, 60 }, {  -2, 59 },
        {  -5, 75 }, {  -3, 62 }, {  -4, 58 }, {  -9, 66 },
